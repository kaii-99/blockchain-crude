...
func init() {
	...
	md_Post = File_crude_crude_post_proto.Messages().ByName("Post")
...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_crude_crude_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message crude.crude.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message crude.crude.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "crude.crude.Post.body":
		panic(fmt.Errorf("field body of message crude.crude.Post is not mutable"))
	case "crude.crude.Post.creator":
		panic(fmt.Errorf("field creator of message crude.crude.Post is not mutable"))
	case "crude.crude.Post.id":
		panic(fmt.Errorf("field id of message crude.crude.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: crude.crude.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in crude.crude.Post", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Post) Descriptor() ([]byte, []int) {
	return file_crude_crude_post_proto_rawDescGZIP(), []int{0}
}
...
var (
	file_crude_crude_post_proto_rawDescOnce sync.Once
	file_crude_crude_post_proto_rawDescData = file_crude_crude_post_proto_rawDesc
)

func file_crude_crude_post_proto_rawDescGZIP() []byte {
	file_crude_crude_post_proto_rawDescOnce.Do(func() {
		file_crude_crude_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_crude_crude_post_proto_rawDescData)
	})
	return file_crude_crude_post_proto_rawDescData
}

var file_crude_crude_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_crude_crude_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: crude.crude.Post
}
var file_crude_crude_post_proto_depIdxs = []int32{
...
func init() { file_crude_crude_post_proto_init() }
func file_crude_crude_post_proto_init() {
	if File_crude_crude_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_crude_crude_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_crude_crude_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_crude_crude_post_proto_goTypes,
		DependencyIndexes: file_crude_crude_post_proto_depIdxs,
		MessageInfos:      file_crude_crude_post_proto_msgTypes,
	}.Build()
	File_crude_crude_post_proto = out.File
	file_crude_crude_post_proto_rawDesc = nil
	file_crude_crude_post_proto_goTypes = nil
	file_crude_crude_post_proto_depIdxs = nil
}
