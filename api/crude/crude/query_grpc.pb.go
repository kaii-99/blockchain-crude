...
const (
	...
	Query_ListResources_FullMethodName = "/crude.crude.Query/ListResources"
	Query_GetResource_FullMethodName   = "/crude.crude.Query/GetResource"
	Query_SayHello_FullMethodName      = "/crude.crude.Query/SayHello"
	Query_ShowPost_FullMethodName      = "/crude.crude.Query/ShowPost"
	Query_ListPost_FullMethodName      = "/crude.crude.Query/ListPost"
)
...
func (c *queryClient) ListResources(ctx context.Context, in *QueryListResourcesRequest, opts ...grpc.CallOption) (*QueryListResourcesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListResources_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetResource(ctx context.Context, in *QueryGetResourceRequest, opts ...grpc.CallOption) (*QueryGetResourceResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetResource_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) ListResources(context.Context, *QueryListResourcesRequest) (*QueryListResourcesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListResources not implemented")
}
func (UnimplementedQueryServer) GetResource(context.Context, *QueryGetResourceRequest) (*QueryGetResourceResponse, error) {
...
func _Query_ListResources_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ListResources_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GetResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_GetResource_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
